# Bruno Fabiani — Data Science Portfolio 🚀

Welcome! This repository hosts the source code for my personal data-science portfolio website.  
It showcases the projects, publications, and credentials that mark my journey from **data analytics** to **data science and AI-powered solutions**.

## 🌟 Highlights
- **Projects** 📊 – ML models, end-to-end data pipelines, and cool visualizations.
